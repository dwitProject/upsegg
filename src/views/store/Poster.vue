    ...
    <v-fade-transition mode="out-in">
      <v-row>
        <v-col v-for="item in list" :key="item.id" cols="12" sm="6" md="2">
          <!-- <v-col cols="2"> -->
          <v-card>
            <v-img :src="item.image" height="280" class="grey darken-4"></v-img>
    ...
    list: [
      {
        ...
        name: "롤 일러스트",
        price: "22,000",
        image: require("../../assets/롤일러스트.jpg"),
      },
      {
        id: 2,
        name: "가렌과초가스",
        price: "18,000",
        image: require("../../assets/가렌과초가스.jpg"),
      },
      {
        id: 3,
        name: "롤 일러스트2",
        price: "25,000",
        image: require("../../assets/롤 일러스트2.jpg"),
      },
    ],
  }),
};
